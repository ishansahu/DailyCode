...
\outl0\strokewidth0 \strokec2 Given a string, determine if it is a palindrome, considering only alphanumeric characters and ignoring cases.\
\pard\pardeftab720\sl340\sa280\partightenfactor0

\f1\b \cf2 Note:
\f0\b0 \'a0For the purpose of this problem, we define empty string as valid palindrome.\
...
\f3\b0  "A man, a plan, a canal: Panama"\
