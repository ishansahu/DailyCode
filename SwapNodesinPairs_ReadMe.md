...
\outl0\strokewidth0 \strokec2 Given a\'a0linked list, swap every two adjacent nodes and return its head.\
You may\'a0
\f1\b not
\f0\b0 \'a0modify the values in the list's nodes, only nodes itself may be changed.\
\'a0\
\pard\pardeftab720\sl340\sa280\partightenfactor0
...
\f2\fs26 \cf2 \cb4 Given 1->2->3->4, you should return the list as 2->1->4->3.\
}